                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user()->avatar != ''): ?><?php echo e(asset(Auth::user()->avatar)); ?> <?php else: ?><?php echo e(asset('assets/images/users/avatar-1.jpg')); ?><?php endif; ?>"
                                alt="Header Avatar">
...
<?php /**PATH /opt/lampp/htdocs/other/autobidder/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>