                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mt-2">
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                                        <span class="counter-value" data-target="<?php echo e($totalShares + $totalProfit); ?>">0</span>
                                                    </h4>
                                                </div>
                                        ...
                                        <div class="card card-animate border">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-2">
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                                        <span
                                                            class="counter-value" data-target="<?php echo e(($totalShares + $totalProfit) - $totalRemainShares); ?>">0</span>
                                                    </h4>
                                                </div>
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        ...
                                        <div class="card card-animate border">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-2">
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-2"><span
                                                            class="counter-value" data-target="<?php echo e($totalRemainShares); ?>">0</span>
                                                    </h4>
                                                </div>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">BEquity Bank Shares</span>
                                            </td>
                                            <td>
                                                <p class="mb-0">8547</p>
                                                <span class="text-muted">Stock</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">KCB Bank Shares</span>
                                            </td>
                                            <td>
                                                <p class="mb-0">895</p>
                                                <span class="text-muted">Stock</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">M-pesa Auction</span>
                                            </td>
                                            <td>
                                                <p class="mb-0">3470</p>
                                                <span class="text-muted">Stock</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">Airtel Shares</span>
                                            </td>
                                            <td>
                                                <p class="mb-0">5488</p>
                                                <span class="text-muted">Stock</span>
                        ...
                        <div class="card-body">
                            <div class="table-responsive table-card">
                                <table
                                    ...
                                    <tbody>
                                    <?php
                                        $recentShares = \App\Models\UserShare::orderBy('id', 'desc')->limit(5)->get();
                                    ?>

                                    <?php $__currentLoopData = $recentShares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentShare): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="fw-medium link-primary"><?php echo e($recentShare->ticket_no); ?></a>
                                            </td>
                                            <td>
                                                <a href="#" class="text-decoration-underline text-blue">
                                                    <?php echo e($recentShare->user->name); ?>

                                                </a>
                                            </td>
                                            <td> <?php echo e($recentShare->trade->name); ?> </td>
                                            <td>
                                                <span class="text-success">
                                                    <?php echo e($recentShare->share_will_get); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if( $recentShare->start_date): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/other/autobidder/resources/views/index.blade.php ENDPATH**/ ?>