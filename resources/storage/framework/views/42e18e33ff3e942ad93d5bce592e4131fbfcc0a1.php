...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-layout="<?php echo e(auth()->user()->role_id != 2 ? 'vertical' : 'horizontal'); ?>" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
