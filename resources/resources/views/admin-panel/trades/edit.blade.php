...
{{--                                    <input type="number" class="form-control" name="quantity" value="{{ $trade->quantity }}" autocomplete="none">--}}
{{--                                    @error('quantity')--}}
{{--                                    <span class="invalid-feedback" role="alert">--}}
{{--                                        <strong>{{ $message }}</strong>--}}
{{--                                    </span>--}}
...
{{--                                    <input type="number" class="form-control" name="buying_price" value="{{ $trade->buying_price }}">--}}
{{--                                    @error('buying_price')--}}
{{--                                    <span class="invalid-feedback" role="alert">--}}
{{--                                        <strong>{{ $message }}</strong>--}}
{{--                                    </span>--}}
...
{{--                            </div>--}}
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label" style="padding-top: 20px;">
                                        <input type="checkbox" name="status" @checked($trade->status == 1)>
                                        <span>Status</span>
                                    </label>
                                </div>
                            </div>
