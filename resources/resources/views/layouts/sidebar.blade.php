...
{{--                            </li>--}}
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCommunication"
                       ...
                       aria-expanded="{{ areActiveRoutesBool(['announcement.create', 'email.create', 'admin.support']) }}"
                       aria-controls="sidebarCommunication"
                    >
                        <i class="ri-message-2-fill"></i> <span>@lang('Communications')</span>
                    </a>
                    <div class="collapse menu-dropdown {{ areActiveRoutesBool(['announcement.index', 'announcement.create', 'announcement.edit', 'email.create', 'admin.support']) ? 'show' : '' }}" id="sidebarCommunication">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarSettings" data-bs-toggle="collapse" role="button" aria-expanded="{{ areActiveRoutesBool(['admin.updateTradingPrice', 'admin.setTaxRate', 'admin.setting.mail.create', 'admin.setting.sms.create']) }}" aria-controls="sidebarShare">
