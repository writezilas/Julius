                                        ...
                                        <div class="card card-animate border">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-2">
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                                        <span
                                                            class="counter-value" data-target="{{ ($totalShares + $totalProfit) - $totalRemainShares }}">0</span>
                                                    </h4>
                                                </div>
{{--                                                <div>--}}
{{--                                                    <a href="" class="text-decoration-underline">@lang('View all')</a>--}}
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mt-2">
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-2"><span
                                                            class="counter-value" data-target="{{ $totalRemainShares }}">0</span>
                                                    </h4>
                                                </div>
{{--                                                <div>--}}
{{--                                                    <a href="" class="text-decoration-underline">@lang('View all')</a>--}}
...
{{--                                            <th scope="col">Action</th>--}}
                                    ...
                                    @foreach($recentShares as $recentShare)
                                        <tr>
                                            <td>
                                                <a href="#"
                                                   class="fw-medium link-primary">{{ $recentShare->ticket_no }}</a>
                                            </td>
                                            <td>
