                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex flex-column h-100">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Borex   . Crafted with <i class="mdi mdi-heart text-danger"></i> <a href="http://md-uzair.com/">Md Uzair</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
