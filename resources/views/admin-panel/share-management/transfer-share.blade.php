    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.allocate.saveTransferShare') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select name="from_user" class="form-control" id="transferShareFromUser">
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" @selected(old('from_user') == $user->id)>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="available_share" id="available_share_per_user" value="{{ old('available_share') }}" autocomplete="none">
                                    @error('available_share')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror
