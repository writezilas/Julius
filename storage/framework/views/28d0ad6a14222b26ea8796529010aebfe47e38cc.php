...
unset($__errorArgs, $__bag); ?>"
                                                name="phone" value="<?php echo e(old('phone')); ?>" id="userphone"
...
unset($__errorArgs, $__bag); ?>"
                                                name="username" value="<?php echo e(old('username')); ?>" id="username"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?php $__errorArgs = ['refferal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                name="refferal" value="<?php echo e(old('refferal') ?? request()->get('refferal_code')); ?>" id="refferal"
                                                placeholder="Enter refferal" <?php if(request()->get('refferal_code')): ?> readonly <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php $__errorArgs = ['business_account_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label for="mpesa_no" class="form-label">MPesa No: <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control <?php $__errorArgs = ['mpesa_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                name="mpesa_no" value="<?php echo e(old('mpesa_no')); ?>" id="mpesa_no"
                                                placeholder="Enter mpesa no" required>
                                            <?php $__errorArgs = ['mpesa_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label for="mpesa_name" class="form-label">MPesa Name: <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control <?php $__errorArgs = ['mpesa_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                name="mpesa_name" value="<?php echo e(old('mpesa_name')); ?>" id="mpesa_name"
                                                placeholder="Enter mpesa name" required>
                                            <?php $__errorArgs = ['mpesa_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?php $__errorArgs = ['mpesa_till_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                name="mpesa_till_no" value="<?php echo e(old('mpesa_till_no')); ?>" id="mpesa_till_no"
                                                placeholder="Enter mpesa till no">
                                            <?php $__errorArgs = ['mpesa_till_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label for="mpesa_till_name" class="form-label">MPesa Till Name: <span
                                                    class="text-text">(Optional)</span></label>
                                            <input type="text" class="form-control <?php $__errorArgs = ['mpesa_till_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                name="mpesa_till_name" value="<?php echo e(old('mpesa_till_name')); ?>" id="mpesa_till_name"
                                                placeholder="Enter mpesa till name">
                                            <?php $__errorArgs = ['mpesa_till_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php $__errorArgs = ['trading_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> <?php echo e(env('APP_NAME', 'Auto Bidder')); ?>. Crafted with <i
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/other/autobidder/resources/views/auth/register.blade.php ENDPATH**/ ?>