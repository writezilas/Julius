        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="<?php echo e(route('admin.staff.index')); ?>" class="btn btn-primary">
                        all staffs
                    </a>
                </div>
                <div class="card-body">
                    <?php echo e(auth()->user()->can('role-edit') ? 'he can' : 'he done'); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="username" value="<?php echo e($user->username); ?>" autocomplete="none">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/other/autobidder/resources/views/admin-panel/staffs/edit.blade.php ENDPATH**/ ?>