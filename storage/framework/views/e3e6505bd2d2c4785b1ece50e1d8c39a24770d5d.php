                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="refferal"
                                                placeholder="Enter your refferal" value="<?php echo e(auth()->user()->refferal_code); ?>" disabled>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="business_account_id" business_account_id="business_account_id"
                                                placeholder="Enter your business_account_id" value="<?php echo e(auth()->user()->business_account_id == 1 ? 'Mpesa' : 'Mpesa Till No'); ?>" readonly>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mpesa_no" name="mpesa_no"
                                                placeholder="Enter your mpesa_no" value="<?php echo e(json_decode(auth()->user()->business_profile,true)['mpesa_no']); ?>" readonly>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mpesa_name"  name="mpesa_name"
                                                placeholder="Enter your mpesa_name" value="<?php echo e(json_decode(auth()->user()->business_profile,true)['mpesa_name']); ?>" readonly>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mpesa_till_no" name="mpesa_till_no"
                                                placeholder="Enter your mpesa_till_no" value="<?php echo e(json_decode(auth()->user()->business_profile,true)['mpesa_till_no']); ?>" readonly>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mpesa_till_name" name="mpesa_till_name"
                                                placeholder="Enter your mpesa_till_name" value="<?php echo e(json_decode(auth()->user()->business_profile,true)['mpesa_till_name']); ?>" readonly>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="trading_category_id" name="trading_category_id"
                                                placeholder="Enter your trading_category_id" value="<?php echo e(auth()->user()->trading_category->name); ?>" readonly>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/other/autobidder/resources/views/user-panel/profile.blade.php ENDPATH**/ ?>