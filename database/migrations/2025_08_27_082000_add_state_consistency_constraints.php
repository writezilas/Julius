    ...
    public function up()
    {
        ...
        Schema::table('user_share_payments', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE user_share_payments ADD CONSTRAINT chk_payment_status_enum 
                CHECK (status IN ('pending', 'confirmed', 'rejected', 'processing'))");
        ...
        // Create state consistency validation function
        DB::unprepared('
        ...
        // Create trigger for pairing consistency (MySQL version)
