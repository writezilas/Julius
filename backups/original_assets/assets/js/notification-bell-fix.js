...
window.refreshNotificationCount = function() {
    ...
    // Use the AdminNotificationBell instance if available
    if (window.adminNotificationBell && typeof window.adminNotificationBell.loadNotifications === 'function') {
        window.adminNotificationBell.loadNotifications();
        console.log('Notification Bell Fix: Using AdminNotificationBell refresh');
    } else {
